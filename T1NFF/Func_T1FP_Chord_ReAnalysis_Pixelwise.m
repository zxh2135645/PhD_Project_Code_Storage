...
for i = 1:size(roi_in_myo_t1, 3)
    ...
    % For debugging
    img_t1_masked = img .* (univ_roi-hemo_mask) .* univ_myo_eroded;
    img_ff_masked = img2 .* (univ_roi-hemo_mask) .* univ_myo_eroded;
    img_r2star_masked = img3 .* (univ_roi-hemo_mask) .* univ_myo_eroded;
    
    img_t1_remote_masked = img .* movingRegistered_remote_ff .* univ_myo_eroded;
    img_ff_remote_masked = img2 .* movingRegistered_remote_ff .* univ_myo_eroded;
    img_r2star_remote_masked = img3 .* movingRegistered_remote_ff .* univ_myo_eroded;
    
    img_t1_hemo_masked = img .* hemo_mask .* univ_myo_eroded;
    img_ff_hemo_masked = img2 .* hemo_mask .* univ_myo_eroded;
    img_r2star_hemo_masked = img3 .* hemo_mask .* univ_myo_eroded;
