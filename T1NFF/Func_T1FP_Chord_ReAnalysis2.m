function Func_T1FP_Chord_ReAnalysis2(Segn, Groove, t1, ff, r2star, myo_t1, myo_ff, roi_in_myo_t1, roi_in_myo_ff, roi_in_myo_r2star, remote_in_myo_t1, remote_in_myo_ff, remote_in_myo_r2star,tp_dir2,name,time_point,LR_mdl_fname,chord_values_fname)
...
for i = 1:size(roi_in_myo_t1, 3)
    ...
    for j = 1:Segn
        ...
        seg_mask_t1_remote = Mask_Segn .* remote_in_myo_ff(:,:,i) .* movingRegistered_eroded == j;
        seg_mask_ff_remote = Mask_Segn2 .* remote_in_myo_ff(:,:,i) .* fixed_eroded == j;
        seg_mask_r2star_remote = Mask_Segn3 .* remote_in_myo_ff(:,:,i) .* fixed_eroded == j;
