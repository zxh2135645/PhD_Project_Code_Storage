function [Mipix_mean_nnz_epi, Mipix_mean2_nnz_epi, Mipix_mean3_nnz_epi, ...
    Mipix_mean_nnz_endo, Mipix_mean2_nnz_endo, Mipix_mean3_nnz_endo] = ...
    Func_plot_chord_analysis_EpiEndo2_Module(Mipix_mean_epi, Mipix_mean2_epi, Mipix_mean3_epi,...
    Mipix_mean_endo, Mipix_mean2_endo, Mipix_mean3_endo, tp_dir2, label)
...
% remove NAs
nan_idx_epi = find(~isnan(Mipix_mean_nnz_epi));
Mipix_mean_nnz_epi = Mipix_mean_nnz_epi(nan_idx_epi);
Mipix_mean2_nnz_epi = Mipix_mean2_nnz_epi(nan_idx_epi);
Mipix_mean3_nnz_epi = Mipix_mean3_nnz_epi(nan_idx_epi);
...
% remove NAs
nan_idx_endo = find(~isnan(Mipix_mean_nnz_endo));
Mipix_mean_nnz_endo = Mipix_mean_nnz_endo(nan_idx_endo);
Mipix_mean2_nnz_endo = Mipix_mean2_nnz_endo(nan_idx_endo);
Mipix_mean3_nnz_endo = Mipix_mean3_nnz_endo(nan_idx_endo);
...
caxis([0 100]);
colormap(brewermap([],'*RdYlBu'));
saveas(gcf, cat(2, tp_dir2, 'Chord_Display_EpiEndo2_', label, '.png'));
...
saveas(gcf, cat(2, tp_dir2, 'Chord_Scatter_EpiEndo2_LReg_', label, '.png'));
