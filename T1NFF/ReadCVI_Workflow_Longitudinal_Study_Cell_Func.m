...
% For - T1_fat_Project - Keyur's Patient dataset
% Because image resolution is different across slice locations

% The size of 90min does not match the rest
function ReadCVI_Workflow_Longitudinal_Study_Cell_Func(con, dicom_glob, dstFolder, dicom_fields, old_freeROI_label)
