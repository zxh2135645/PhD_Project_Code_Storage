function [x,flag,relres,iter,resvec] = pcg1(A,b,tol,maxit,M1,M2,x0,flagShowProgress,varargin)
...
if flagShowProgress
    ...
    waitbar(0, progress, sprintf('Preconditioned conjugate gradients...'));
end
