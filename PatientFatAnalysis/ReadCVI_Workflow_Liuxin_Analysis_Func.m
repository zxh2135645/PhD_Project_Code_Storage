...
function ReadCVI_Workflow_Liuxin_Analysis_Func(con, dicom, dstFolder, dicom_fields, old_freeROI_label, echo_idx_te)
...
match_count2 = 0;
    ...
    if any(strcmp(label, t2star_labels))
        ...
        [mask_heart2, mask_myocardium2, mask_blood2, excludeContour2, myoRefCell2, ~, freeROICell2, match_count2, contour_idx2] = ...
            CMR42ContourMatrixGenerator4(con, volume_image_te, slice_data_te, dstFolder, old_freeROI_label);
    end
    ...
    if match_count2 > 0
        if any(strcmp(label, t2star_labels))
            glob_idx_te = contour_idx2(contour_idx2~=0);
        end
    end
...
if total_match ~= 0
    ...
    if any(strcmp(label, t2star_labels))
        ...
        Index.glob_names = strings{end-1};
        Index.glob_idx = glob_idx;
        Index.echo_idx_te = echo_idx_te;
        Index.glob_idx_te = glob_idx_te;
