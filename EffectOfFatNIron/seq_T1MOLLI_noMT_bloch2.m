function [t_total, M_total_total, t_readout_array, Mxy_readout_array] = seq_T1MOLLI_noMT_bloch2(TI_array, TD, npulse, T1, T2, alpha, TR, prep, M0, trigger, trigger2, df, adiabatic, varargin)
