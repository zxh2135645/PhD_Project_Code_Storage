...
%
% Outputs:
%       t:           Time array (ms)           e.g. 1x340 double (0 - 816)
%       M_total:     temporal evolution of M   e.g. 3x340 double
%       Mxy_readout: Mxy at the readout        e.g. 0.0003 + 0.1592i  complex double 
%       t_readout:   at the readout time point e.g. 720 (ms) (t still doesn't match)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
