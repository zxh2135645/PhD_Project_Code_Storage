...
for j = 1:length(Phantom_shape_cell) %loop the code 4 times to produce 4 different phantoms
 ...
 %% Crop masks
    ...
    %save('C:\Users\MRI\Documents\James_Data\T2star_SimulationPhantom\Ellipsoid_Phantom.mat', 'Phantom_shape_cell', '-v7.3');
%%
    save('C:\Users\xz100\Documents\Data\T2star_SimulationPhantom\Ellipsoid_Phantom_BalanceRemote.mat', 'Phantom_shape_cell', '-v7.3');
