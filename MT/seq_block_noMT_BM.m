function [t, Mz_total, mxys_array, mzs_array, Mxy_readout, corespond_t] = seq_block_noMT_BM(TD, npulse, T1, T2, alpha, TR, prep, num_rampup, Mz0, varargin)
%% Extra variables
...
% Need to relax before prep pulse %%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EDIT HERE%%
...
% Apply inversion pulse and bSSFP readout %%%%%%%%%%%%%%%%%%%%% EDIT HERE
