...
%     erg_previous = energy_ho_3d(kappa,psi,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant);
    ...
    kappa_Mask = kappa;
    psi_Mask = psi;
    erg_previous = energy_ho_3dW2_Chris_1002(voxel_size,iMag_Mask,kappa_Mask,psi_Mask,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant,Mask);
%     erg_previous = 1e10;
...
%       erg_actual = energy_ho(kappa_aux,psi,base,p,cliques,disc_bar,th,quant);
        ...
        psi_Mask = psi;
        erg_actual = energy_ho_3dW2_Chris_1002(voxel_size,iMag_Mask,kappa_aux_Mask,psi_Mask,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant,Mask);
