% 2019 Randy Yang Cedars Sinai Correct for fat and water swap
...
function [kappa,m_fat,unwph,iter,erglist,kappa_iter] = unwrap_unfat_3dP_UNIC_Chris_1002(voxel_size,iMag,w,psi,p,Mask,varargin)
...
%     erg_previous = energy_ho_3d_pi(kappa,psi,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant);
    ...
    erg_previous = energy_ho_3dW2_pi_Chris_1002(voxel_size,iMag_Mask,kappa_Mask,psi_Mask,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant,Mask);
...
%       erg_actual = energy_ho_3d_pi(kappa_aux,psi,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant);
        ...
        erg_actual = energy_ho_3dW2_pi_Chris_1002(voxel_size,iMag_Mask,kappa_aux_Mask,psi_Mask,base_xy,base_z,p,cliques,disc_bar,disc_bar_z,th,quant,Mask);
        %       
