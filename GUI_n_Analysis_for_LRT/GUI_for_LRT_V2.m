classdef GUI_for_LRT_V2 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function LoadDataButtonPushed(app, event)
            ...
            if numel(df.sizes) == 5
                ...
                app.TemporalSlider.Limits = [1 df.sizes(5)];
                app.TemporalSlider.Value = 1;
                app.TemporalSlider.MajorTicks = [1:1:df.sizes(5)];
        ...
        function update_axes(app, event)
            ...
            if numel(size(app.Phi)) == 5
                ...
                elseif app.img_label == 0
                    app.temp1 = app.Gr\reshape(app.Phi(:,end,1,1,app.TemporalSlider.Value), app.L, []);
                    app.temp1 = reshape(reshape(app.dispim(reshape(app.U,app.Ny,app.Nx,app.Nz,[])),[],app.L)*app.temp1, app.Ny, app.Nx, [], app.params.NEco);
                    app.cw = 0.5*max(app.vec(abs(app.temp1)));
                ...
                if app.img_label == 2 || app.img_label == 5
                    imagesc(abs(app.temp1(:,:,app.T1Slider.Value, 1)/app.cw), 'Parent', app.ax1);
                elseif app.img_label == 3
                    imagesc(abs(app.temp1(:,:,app.CardiacSlider.Value, 1)/app.cw), 'Parent', app.ax1);
                elseif app.img_label == 4
                    imagesc(abs(app.temp1(:,:,app.RespiratorySlider.Value, 1)/app.cw), 'Parent', app.ax1);
                elseif app.img_label == 0 || app.img_label == 1
                    imagesc(abs(app.temp1(:,:,:,1)/app.cw), 'Parent', app.ax1);
                elseif app.img_label == 6
                    imagesc(abs(app.temp1(:,:,app.TemporalSlider.Value, 1)/app.cw), 'Parent', app.ax1);
                end
...
%             app.T2starSlider.Position = [90 306 117 3];
            ...
            app.RespiratorySliderLabel.Position = [33 296 39 22];
            ...
            app.CardiacSlider.Position = [90 234 117 3];
            ...
            app.TemporalSliderLabel.Position = [27 153 45 22];
            ...
            app.TemporalSlider.Position = [90 163 117 3];
