...
function t1_map_2d = T1Mapping_DictFit_Func2_Anzhen(ipt_2d, mask_1d, Mz_dict_norm_abs_truc, Nydisp, Nxdisp, T1s)
...
for ii = (1:size(ipt_2d, 1))
    if mask_1d(ii)
        ...
        ipt_2d_norm = repmat(ipt_1d_norm', [1 size(Mz_dict_norm_abs_truc, 2)]);
...
t1_map_2d = reshape(t1_map_1d, Nydisp, Nxdisp) * 1000;
